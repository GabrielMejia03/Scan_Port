...
# 2086046
#
# Escaneo de puertos (más comunes ) en equipos de 
# misma subred
#
# Determinando gateway
$subred = $subred = (Get-NetRoute -DestinationPrefix 0.0.0.0/0).NextHop
...
#
$portstoscan = @(20,21,22,23,25,50,51,53,80,110,119,135,136,137,138,143,161,161,162,389,443,445,636,1025,1443,339,5985,5986,8080,10000)
$waittime = 100
#
